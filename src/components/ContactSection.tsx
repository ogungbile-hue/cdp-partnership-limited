        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start bg-black/40 p-8 rounded-2xl border border-white/10 backdrop-blur-md relative overflow-hidden">
            ...
            <div className="flex flex-col relative z-10">
              ...
              <a href="#" className="text-red-400 hover:text-red-300 text-sm font-medium transition-colors flex items-center gap-1 w-fit">
                Read More <ArrowRight size={14} />
              </a>
            </div>
          </div>

          <div className="flex flex-col md:flex-row gap-8 items-start bg-black/40 p-8 rounded-2xl border border-white/10 backdrop-blur-md relative overflow-hidden mt-6">
            <div className="absolute -top-24 -right-24 w-64 h-64 bg-red-900/20 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <div className="w-24 h-24 shrink-0 rounded-full bg-white/10 border-2 border-white/20 overflow-hidden relative shadow-2xl flex items-center justify-center">
              ...
              <img src="/assets/team/paul-anavhe.jpg" alt="Paul Anavhe Junior" className="w-full h-full object-cover relative z-10 opacity-0 transition-opacity duration-500" onLoad={(e) => e.currentTarget.style.opacity = '1'} onError={(e) => e.currentTarget.style.display = 'none'} />
            </div>

            <div className="flex flex-col relative z-10">
              <h4 className="text-2xl font-bold text-white mb-1 drop-shadow-md">Paul Anavhe Junior</h4>
              <span className="text-red-400 font-medium tracking-wide mb-4 text-sm">Executive Partner</span>
              <p className="text-white/70 font-light leading-relaxed mb-4">
                Seasoned Quantity Surveyor, Project Manager, Arbitrator, and Construction Manager with extensive experience in international and global management.
              </p>
              <a href="#" className="text-red-400 hover:text-red-300 text-sm font-medium transition-colors flex items-center gap-1 w-fit">
                Read More <ArrowRight size={14} />
              </a>
